...
export default function DashboardScreen() {
  ...
  const handleInlineToggle = async (habitId: string) => {
    if (submittingHabitIds.has(habitId)) return;
